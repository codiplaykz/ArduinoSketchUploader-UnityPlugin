...
public class Avr109BootloaderProgrammer<E extends ISerialPortStream> extends ArduinoBootloaderProgrammer<E> {
	...
	public void Close() {
		try {
			final String currentPort = getSerialPort().getPortName();
			if (getLogger() != null)
			...
			String result = WaitHelper.WaitFor(timeoutVirtualPointDisappearance, virtualPortDisappearanceInterval,
					new Func0<String>() {
						...
						public String invoke() {
							return portNames.contains(currentPort) ? null : currentPort;
						}
					},
					new Func3<Integer, String, Integer, String>() {
						@Override
						public String invoke(Integer i, String item, Integer interval) {
							return item == null ? String.format("T+%1$s - Port still present...", i * interval)
