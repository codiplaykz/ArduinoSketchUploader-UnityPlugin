...
public final class WaitHelper {
    ...
    public static <T> T WaitFor(int timeout, final int interval, final Func0<T> toConsider, final Func3<Integer, T, Integer, String> format) {
        Future<T> task = executor.submit(new Callable<T>() {
            @Override
